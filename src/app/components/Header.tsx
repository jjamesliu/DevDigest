...
export default function Header() {
    return (
        <motion.div className="mt-4 flex items-center justify-between mx-auto max-w-md md:max-w-2xl lg:max-w-4xl rounded-full px-4 py-2 bg-[#161616] backdrop-blur-lg border border-white/20 "
